...
def display_coord(coord):
    ...
    num_of_1 = np.count_nonzero(coord==1)
    num_of_0 = np.count_nonzero(coord==0)
    print('num of 1: %d, num of 0: %d' %(num_of_1,num_of_0))
    #strArr[coord==1] = 'O'
    cond = coord==1         # boolean array
    print(cond)
    strArr[~cond] = '='  #'=' #' '  
    print(strArr)    
    strArr[cond] = 'O'
    ...
    strArr[~cond] = '='
    print(strArr)
    num_of_bO = np.count_nonzero(strArr==b'O')
    num_of_be = np.count_nonzero(strArr==b'=')
    #print('num of "O": %d, num of "=": %d' %(num_of_bO,num_of_be))
